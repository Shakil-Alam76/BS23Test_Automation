...
public class Booking extends DriverSetup{
	...
	public static void PHPTravelsBooking() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='col-md-6 col-12 o2']//span[contains(text(),'Email')]")).sendKeys("shakil.shanto76@gmail.com");
		driver.findElement(By.xpath("//span[normalize-space()='Confirm']")).sendKeys("shakil.shanto76@gmail.com");
		driver.findElement(By.xpath("//span[normalize-space()='Contact Number']")).sendKeys("01685822476");
